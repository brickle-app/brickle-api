...
namespace BricklePlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260902154528_AddUserDocumentSignatureTable")]
    partial class AddUserDocumentSignatureTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BricklePlatform.Domain.Entities.Investment", b =>
                {
                    ...
                    b.Property<decimal>("BricksCount")
                        .HasColumnType("decimal(18,2)")
            ...
            modelBuilder.Entity("BricklePlatform.Domain.Entities.Leasing", b =>
                {
                    ...
                    b.Property<string>("DiscoverImageUrl")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal>("ReteFuentePct")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("ReteIcaPct")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);
            ...
            modelBuilder.Entity("BricklePlatform.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("IsProfileUnderReview")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("BricklePlatform.Domain.Entities.UserBankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("AccountDocument")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
            ...
            modelBuilder.Entity("BricklePlatform.Domain.Entities.UserDocumentSignature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("UserDocumentSignature", "dbo");
                });
            ...
            modelBuilder.Entity("BricklePlatform.Domain.Entities.UserLeasingAgreement", b =>
                {
                    ...
                    b.Property<decimal>("BuyerRetentionPercentage")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m)
            ...
            modelBuilder.Entity("BricklePlatform.Domain.Entities.WalletBackup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("KdfParamsJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("kdf_params_json");
            ...
            modelBuilder.Entity("BricklePlatform.Domain.Entities.WalletBackup", b =>
                {
                    b.HasOne("BricklePlatform.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("BricklePlatform.Domain.Entities.WalletBackup", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
